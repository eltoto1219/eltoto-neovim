...
M.sections = {
    {
        ...
        entries = {
            ...
            { lhs = ":TerminalRename",            desc = "rename the current terminal buffer; an empty name resets plain terminals, while persistent terminals retain their P:/P:th: prefix and require a name" },
    ...
    },
    {
        ...
        entries = {
            ...
            { lhs = "<leader>M", desc = "pick Claude or Codex and open a new AI session buffer" },
            { lhs = "<leader>nn", desc = "open a picker of AI sessions, named as in the tabline: open ones switch, cached ones are marked and resume on selection" },
            { lhs = "<leader>nk", desc = "kill the current AI buffer, or select an open one to kill; kills drop the session from the cache" },
            { lhs = "<leader>nK", desc = "kill all open AI buffers at once (cached sessions stay restorable)" },
    ...
    },
    {
        ...
        entries = {
            ...
            { lhs = "<leader>b",  desc = "Telescope buffer picker" },
            ...
            { lhs = "qq",         desc = "close the current window when multiple normal windows are visible; otherwise close the current buffer; terminals prefer the same AI/plain type, then another terminal, then a file; quit when no other real buffer remains" },
            { lhs = "<leader>y",  desc = "jump to the alternate or last file buffer" },
        },
    },
    {
    ...
    },
    {
        ...
        entries = {
            ...
            { lhs = "terminal <leader>r", desc = "rename the current terminal buffer; persistent terminals keep their P:/P:th: prefix" },
            { lhs = "terminal qa",        desc = "force quit the current window" },
            { lhs = "terminal qq",        desc = "close the current window if split; otherwise close this terminal and switch to another of the same AI/plain type, falling back to another terminal then a file, or quit if none remain" },
    ...
    },
    {
        ...
        entries = {
            ...
            { lhs = "<leader>pA",         desc = "attach all persistent terminal processes created in the current working directory" },
