...
map("n", "<leader>a", ai_sessions.toggle, { silent = true, desc = "Toggle AI buffer" })
map("n", "<leader>d", ai_sessions.pick, { silent = true, desc = "AI session picker" })
map("n", "<leader>A", ai_sessions.new_session, { silent = true, desc = "New AI session" })
