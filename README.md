...
- `<leader>fa`: acquire a disposable treehouse workspace and open a persistent session inside it; a popup offers to start claude or codex there (Esc keeps a plain shell)
